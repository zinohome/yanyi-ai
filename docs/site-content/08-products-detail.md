...
- **多模态融合与入库** — 融合视觉、时序与文档数据，规范化写入 IndustriaMemory。
...
## MedicaMemory 医学统一记忆平台

- 路径：`/products/medicamemory`
> 让医疗机构拥有自己的医学知识记忆
...
- **供给推理** — 作为 MedicaMind 的事实来源，带出处返回
...
## MedicaVoice 医疗实时语音底座

- 路径：`/products/medicavoice`
> 把说过的话，变成可用的记录
...
## MedicaVision 医学视觉智能底座

- 路径：`/products/medicavision`
> 让影像与实验图像成为可推理的证据
...
- **融合与复核** — 与文献、临床数据在 MedicaMemory 中融合；结论交专家复核
