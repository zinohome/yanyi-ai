...
export const buildSolutions = (lang: Lang) => {
  ...
  return {
    ...
    layout: [
      ...
      {
        blockType: 'scenarioShowcase',
        title: t('IndustriaX 制造业解决方案', 'IndustriaX · Manufacturing Solutions'),
        subtitle: t('覆盖研发设计、工程知识、质量闭环与生产优化，把可复用的 AI Agent 能力组合为面向制造业务成效的行业解决方案。', 'Across design, engineering knowledge, quality and operations — reusable AI-agent capabilities composed into outcome-oriented manufacturing solutions.'),
        scenarios: [
          {
            icon: 'sparkles',
            name: t('IndustriaX Engineering 工程研发智能体', 'IndustriaX Engineering'),
            description: t(
              '面向研发设计、工程仿真与设计变更场景，结合设计知识库、约束求解、仿真模型与历史案例，辅助方案探索、轻量化选型、参数优化与研发周期压缩。',
              'For design, simulation and change scenarios — a design knowledge base, constraint solving, simulation and historical cases aid option exploration, lightweighting, parameter tuning and shorter R&D cycles.',
            ),
          ...
          },
          {
            ...
            description: t(
              '沉淀设计规范、工艺文件、历史项目、故障案例与专家经验，构建可检索、可推理、可复用的工程知识底座，支撑知识问答、经验复用与新人辅助。',
              'Sediments specs, process docs, historical projects, failure cases and expertise into a searchable, reasoning-ready knowledge base for Q&A, reuse and onboarding.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
          {
            ...
            description: t(
              '打通视觉质检、缺陷识别、质量数据、失效分析与整改验证，辅助完成问题定位、根因分析、8D 报告、设计反哺与工艺优化，让质量问题可发现、可定位、可复盘、可改进。',
              'Connects visual inspection, defect recognition, quality data, failure analysis and corrective verification — localizing issues, root cause, 8D reports and design/process feedback.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
          {
            ...
            description: t(
              '打通设备、产线、能耗、排产与异常数据，辅助完成生产调度、能耗优化、设备维护、异常预警与运营决策，提升生产效率并降低非计划停机。',
              'Connects equipment, line, energy, scheduling and anomaly data to aid dispatch, energy optimization, maintenance, alerting and operations decisions.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
        ],
      ...
      {
        blockType: 'scenarioShowcase',
        title: t('MedicaX 医疗科研与转化 AI 工作台矩阵', 'MedicaX · Medical R&D and Translation Workbenches'),
        subtitle: t('以人机协同与私有化合规为前提，面向医院、重点实验室与医企合作场景，构建从科研管理、临床研究到成果转化的企业级 AI 底座。', 'Human-in-the-loop and private-compliant — an enterprise AI base spanning research management, clinical study and translation for hospitals, key labs and hospital-industry collaboration.'),
        scenarios: [
          {
            icon: 'microscope',
            name: t('MedicaX Lab 医学实验室 AI 工作台', 'MedicaX Lab'),
            description: t(
              '面向医院重点实验室与科研团队，覆盖课题与合作项目管理、文献与科研辅助、专家知识沉淀、数据标签体系、专利 / 软著 / 项目书辅助，沉淀可复用、可协同、可审计的科研资产。',
              'For key labs and research teams — project management, literature support, expert-knowledge capture, data labeling, and patent/software-copyright/proposal assistance, building reusable, collaborative, auditable research assets.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
          {
            ...
            description: t(
              '面向医学成果转化场景，构建科研项目库、成熟度评估、转化路径、材料生成、企业匹配与管理驾驶舱，帮助科研成果从实验室走向临床验证和产业合作。',
              'For medical translation — a project library, maturity assessment, translation pathways, material generation, enterprise matching and a management cockpit to move results from lab to clinic and industry.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
          {
            icon: 'stethoscope',
            name: t('MedicaX Clinical Agent 临床科研 Agent', 'MedicaX Clinical Agent'),
            description: t(
              '面向临床医生和研究团队，辅助完成临床问题拆解、研究设计、文献证据检索、病例数据整理、随访分析、论文与课题材料生成，让临床经验更快转化为科研成果。',
              'For clinicians and research teams — question decomposition, study design, evidence retrieval, case-data organization, follow-up analysis and paper/proposal drafting.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
          {
            ...
            description: t(
              '面向医院、企业与投资方，围绕真实临床需求开展场景定义、验证方案设计、数据证据沉淀和试点项目管理，推动医企创新从概念验证走向落地转化。',
              'For hospitals, enterprises and investors — scenario definition, validation design, evidence capture and pilot management, moving innovation from proof-of-concept to real translation.',
            ),
            link: { label: t('了解详情', 'Learn More'), href: '/contact' },
          },
        ],
